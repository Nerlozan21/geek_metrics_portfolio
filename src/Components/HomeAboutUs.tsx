          ...
          <div className="col-12 col-lg-6 col-xl-7">
            <div className="row justify-content-xl-center">
              <div className="col-12 col-xl-11">
                ...
                <p className="lead">
                  The key to reaching this level of consistency is in developing
                  a work process, and then refining and improving that process
                  with each subsequent project. We’re going to take a look at
                  some work process improvement ideas that will help you grow
                  your business. we will help accurate measurement and tracking
                  is the foundation of every high-performing website and
                  marketing department. Today’s savvy business owners and
                  marketing executives demand better information. They know that
                  gut intuition plus marketing analytics data beats gut
                  intuition alone—every single time.
                </p>
                <p className="lead">
